...
const aiFutureHistory: TimelineEvent[] = [
  ...
  { id: 'aif-v4', year: 2024, month: 10, title: 'アモデイ「強力なAIは2026年に」', description: 'Anthropicのダリオ・アモデイCEOがエッセイ「Machines of Loving Grace」で「強力なAIは早ければ2026年に来る可能性がある」と予測。AIにより人間の50〜100年分の生物学的進歩を5〜10年に圧縮できる「圧縮された21世紀」を提唱。（darioamodei.com）', categories: ['AI', '識者の予測'] },
  { id: 'aif-v5', year: 2024, month: 10, title: '孫正義「ASIは10年以内、人間の叡智の1万倍」', description: '孫正義がSoftBank World 2024で「人間の叡智の1万倍のASI（人工超知能）が10年以内に来る」と宣言。AGI予測を前年の10年以内から2〜3年後に大幅前倒し。（Logmi、Impress Watch）', categories: ['AI', '識者の予測'] },
  ...
  { id: 'aif-v13', year: 2026, month: 1, title: 'マスク「真のAGIは2026〜2027年」', description: 'イーロン・マスクが「真のAGIは2026〜2027年、超知能は2030年頃」と予測。「3年以内にロボットが最高の外科医を超える」「2030年までにAIの集合知能が全人類の知能を超える」と発言。（Fortune、NextBigFuture）', categories: ['AI', '識者の予測'] },
  ...
  { id: 'aif-v15', year: 2026, title: 'ハサビス「AGI実現確率は2030年末で約50%」', description: 'Google DeepMindのデミス・ハサビスCEOが人間レベルのAIは5〜10年以内に到来と予測。2030年末までのAGI実現確率を約50%と見積もる。業界リーダーの中では比較的慎重な見方。（CNBC、Fortune）', categories: ['AI', '識者の予測'] },
  // 未来予想（予測の統合）
